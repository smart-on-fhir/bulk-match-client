...
describe('kick-off', () => {
    ...
    it("can make a system-level export", async () => {
        ...
        // @ts-ignore
        const client = new BulkMatchClient({ ...baseSettings, fhirUrl: mockServer.baseUrl, global: true })
        await client.kickOff()
    })
    ...
    it("can make a group-level export", async () => {
        ...
        // @ts-ignore
        const client = new BulkMatchClient({ ...baseSettings, fhirUrl: mockServer.baseUrl, group: "abc" })
        await client.kickOff()
    })
})
