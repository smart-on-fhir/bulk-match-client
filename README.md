...
-   _object_ **`privateKey`** - The private key (as [JWK](https://github.com/panva/jose/blob/main/docs/interfaces/types.JWK.md)) used to sign authentication tokens. This is not needed for open servers
